        ...
        while (loggato) {
            ...
            switch (sceltaMenu) {
                ...
                case 3:
                    ...
                    biblioteca.prendiInPrestito(risorse, codiceID); //richiamo la funzione
                    break;
                case 4:
                    //Restituisco libro 
                    System.out.println("Inserisci codice ID: "); //chiedo codice libro
                    int idRestituito = myScannerInt.nextInt(); //inizializzo la variabile                   
                    biblioteca.restituisci(risorse, idRestituito); //chiamo metodoper la restituzione
                    break;
                //Esci
                case 5:
                    // messaggio di uscita
